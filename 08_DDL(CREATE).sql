...
-- MEMBER 테이블
CREATE TABLE "MEMBER"( -- "" 없어도 되지만 예약어와 겹칠때 안 될 때가 있음
...
-- * INSERT/UPDATE 시 컬럽 값으로 DEFAULT 를 작성하면
...
INSERT INTO "MEMBER" VALUES
('MEM02', 'QWER1234', '김영희', '000123-2244335', SYSDATE);


-- 가입일 -> INSERT 시 미작성 하는 경우 DEFAULT 값이 반영 되는지 확인
...
-- ORA-01400: NULL을 ("KH_SDK"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
INSERT INTO USER_USED_UK
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_SDK.USER_ID_U)에 위배됩니다
...
INSERT INTO USER_USED_UK2
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_SDK.USER_ID_NAME_U)에 위배됩니다
-- 복합키로 지정된 컬럼값 중 하나라도 다르면 위배됮 ㅣ않음
--> 모든 커럶의 값이 중복되면 위배된다
...
INSERT INTO USER_USED_PK
VALUES (1, 'USER02', 'PASS02', '이순신', '남자', '010-2222-222', 'lee234@kh.or.kr');
-- 기본키 중복 오류
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_SDK.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES (NULL, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1111', 'yoo456@kh.or.kr');
-- 기본키 NULL 이므로 오류
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_SDK"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK
VALUES (2, 'USER03', 'PASS03', '유관순', '여자', '010-1212-1111', 'yoo456@kh.or.kr');
...
INSERT INTO USER_USED_PK2
VALUES (1, 'USER02', 'PASS02', '이순신', '남자', '010-1234-121', 'lee234@kh.or.kr');

INSERT INTO USER_USED_PK2
VALUES (2, 'USER01', 'PASS02', '이순신', '남자', '010-1234-121', 'lee234@kh.or.kr');

INSERT INTO USER_USED_PK2
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_SDK.PK_USERNO_USERID)에 위배됩니다
-- USER_NO, USER_ID 둘 다 중복 되었을때만 제약 조건 위배 에러 발생

INSERT INTO USER_USED_PK2
VALUES (NULL, 'USER03', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_SDK"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
CREATE TABLE USER_GRADE(
	GRADE_CODE NUMBER PRIMARY KEY, -- 등급 고유번호
...
CREATE TABLE USER_USED_FK(
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	GRADE_CODE NUMBER CONSTRAINT GRADE_CODE_FK REFERENCES USER_GRADE/*(GRADE_CODE) 생략 시 자동으로 PK 지정*/ 
	-- 컬럼 레벨 작성 법
...
INSERT INTO USER_USED_FK
VALUES (2, 'USER02', 'PASS02', '이순신', '남자', '010-5678-1234', 'lee123@kh.or.kr', 10);
-- USER_GRADE (부모테이블/참조테이블)에 10 이라는 GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK
VALUES (3, 'USER03', 'PASS03', '유관순', '여자', '010-3322-1100', 'yoo123@kh.or.kr', 30);
-- USER_GRADE (부모테이블/참조테이블)에 30 이라는 GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK
VALUES (4, 'USER04', 'PASS04', '안중근', '남자', '010-1233-6675', 'ahn123@kh.or.kr', NULL);
-- NULL도 사용가능

INSERT INTO USER_USED_FK
VALUES (5, 'USER05', 'PASS05', '윤봉길', '남자', '010-4533-8975', 'yoon123@kh.or.kr', 50);
-- SQL Error [2291] [23000]: 
-- ORA-02291: 무결성 제약조건(KH_SDK.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- ORA-02292: 무결성 제약조건(KH_SDK.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
DELETE FROM USER_GRADE2 WHERE GRADE_CODE = 10; -- 10을 사용하고 있던 자식 레코드 값이 NULL이 됨을 확인
...
-- 보무 참조키를 사용한 자식 행이 삭제됨을 확임
SELECT * FROM USER_GRADE3; -- 부모에서 10 삭제됨
SELECT * FROM USER_USED_FK3; -- 부모의 10을 참조하고 있던 자식 행 삭제
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_SDK.GENDER_CHECK)이 위배되었습니다

INSERT INTO USER_USED_CHECK
VALUES (1, 'USER01', 'PASS01', '홍길동', '남', '010-1234-5678', 'hong123@kh.or.kr');

INSERT INTO USER_USED_CHECK
VALUES (2, 'USER02', 'PASS02', '유관순', '여', '010-1256-5988', 'yoo123@kh.or.kr');

INSERT INTO USER_USED_CHECK
VALUES (3, 'USER03', 'PASS03', '신사임당', '여자', '010-1236-5988', 'shin123@kh.or.kr');
-- SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_SDK.GENDER_CHECK)이 위배되었습니다


--> GENDER 컬럼에 CHECK 제약조건으로 '남' 또는 '여' 만 삽입 가능하돌고 설정해둠
